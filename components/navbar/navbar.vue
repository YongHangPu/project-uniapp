<template>
  <view class="nav">
    ...
    <view
      v-if="isHome"
      class="headNav pl20rpx"
      :style="{ height: navHeight + 'rpx', 'line-height': navHeight + 'rpx' }">
      ...
      <view class="flex-1">
        ...
        <navigator
          ...
          :style="{
            ...
            'margin-top': menu.top * 2 - status + 'rpx',
            'margin-left': '32rpx',
    ...
    <view v-else class="navbar" :style="'height:' + navHeight + 'rpx;' + containerStyle">
      <view class="back-icon" @click="backOrHome">
        <image v-if="pages > 1" src="../../static/resource/navbar/ic_back.png" />
        <image v-else src="../../static/resource/navbar/ic_home.png" />
      </view>
      <view class="nav-title" v-if="titleText">
        <view
          :style="{
            height: navHeight + 'rpx',
            'line-height': navHeight + 'rpx',
            textStyle,
          }">
          {{ titleText }}
        </view>
